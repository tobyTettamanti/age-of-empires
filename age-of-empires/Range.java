...
public class Range extends Building implements Creating {


    public Range(double xLoc, double yLoc, Player player) {
    ...
    public ImageView setImage(double xLoc, double yLoc) {
        try {
            ImageView imageView = new ImageView(new Image(new FileInputStream("Archery_Range.png")));
            imageView.setX(xLoc);
            imageView.setY(yLoc);
