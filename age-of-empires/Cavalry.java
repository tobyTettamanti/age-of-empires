...
public class Cavalry extends Unit implements Attacking {

    public Cavalry (Cavalry cavalry) {
        super(cavalry.getMorale(), 6, 40, 10, 1, cavalry.getXLoc(), cavalry.getYLoc(), cavalry.getPlayer());
    }

    public Cavalry(double xLoc, double yLoc, Player player) {
    ...
    public int loseMorale(int moraleDamage) {
        int remainingMorale = this.getMorale();
        return remainingMorale =- moraleDamage;
    }
    ...
    public int getDefense() {
        ...
        public ImageView setImage(double xLoc, double yLoc) {
            try {
                ImageView imageView = new ImageView(new Image(new FileInputStream("Cavalry.png")));
                imageView.setX(xLoc);
                imageView.setY(yLoc);
                return imageView;
